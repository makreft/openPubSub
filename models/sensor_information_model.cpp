...
static void manuallyDefineCyberPhysicalSystem(UA_Server *server) {
    UA_NodeId pumpId; /* get the nodeid assigned by the server */
    UA_ObjectAttributes oAttr = UA_ObjectAttributes_default;
    oAttr.displayName = UA_LOCALIZEDTEXT("en-US", "CyberPhysicalSystem");
    UA_Server_addObjectNode(server, UA_NODEID_NULL,
                            UA_NODEID_NUMERIC(0, UA_NS0ID_OBJECTSFOLDER),
                            UA_NODEID_NUMERIC(0, UA_NS0ID_ORGANIZES),
                            UA_QUALIFIEDNAME(1, "CyberPhysicalSystem"),
                            UA_NODEID_NUMERIC(0, UA_NS0ID_BASEOBJECTTYPE),
                            oAttr, NULL, &pumpId);

    UA_VariableAttributes mnAttr = UA_VariableAttributes_default;
    UA_String manufacturerName = UA_STRING("Espressif Systems");
    ...
    UA_String modelName = UA_STRING("ESP 32");
...
static void addCyberPhysicalSystemInstance(UA_Server *server, char *name) {
    UA_ObjectAttributes oAttr = UA_ObjectAttributes_default;
...
int main()
{
    ...
    manuallyDefineCyberPhysicalSystem(ua_server);
    defineObjectTypes(ua_server);
    addCyberPhysicalSystemInstance(ua_server, "CPS1");
    addCyberPhysicalSystemInstance(ua_server, "CPS2");
    addCyberPhysicalSystemTypeConstructor(ua_server);
    addCyberPhysicalSystemInstance(ua_server, "CPS3");
    addCyberPhysicalSystemInstance(ua_server, "CPS4");
    server.run();
